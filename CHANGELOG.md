...
- chore: deleting a slice or article also removes its preview cache files (`SLICE_DELETED` / `ART_DELETED`)
...
- chore: bumped dev dependencies (postcss-selector-parser 7.1.5, fast-uri 3.1.7, browserslist 4.28.9, js-yaml 4.3.2)
