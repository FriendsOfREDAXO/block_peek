...
if (rex_post('btn_save_template', 'string') !== ''
    ...
    // setWhere with assoc array → named params; positional '?' would clash
    // with the :name placeholders generated by setValue()/addGlobalUpdateFields()
    // (PDO disallows mixing named and positional parameters → HY093).
